...
echo "  2. Se quiser gerar o scaffold de AI agents em outro repositório, execute: npm run init-ai"
echo "  3. Execute: bash scripts/test_models.sh"
echo "  4. Explore: cd examples/depurador-claude && claude"
echo ""
